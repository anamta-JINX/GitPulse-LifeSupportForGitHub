...
class RepoConfig:
    ...
    # Daily is retained for existing installations. New UI-created repositories
    # use span mode, including before their first plan has been saved.
    ...
    def from_dict(cls, data: dict[str, Any]) -> "RepoConfig":
        ...
        item = cls(**allowed)
        if item.calendar_plan:
            item.schedule_mode = "span"
